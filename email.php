...
$mail->Body = "Name: ".$Name."<br>Email: ".$Email."<br>Company: ".$Company."<br>Phone: ".$Phone."<br>Country: ".$Country."<br>Message: ".$Message; //郵件內容
...
$mail->AddBCC("cuxy1111@gmail.com"); //設定 密件副本收件者
