(function($) {
    ...
    var slider = $('.single-carousel-thumb');
...
===========================*/
    ...
    /*===========================
    	FilterForm Search FUNCTION START
    ===========================*/
    jQuery(document).on('click', '#filterform #filterSubmit', e => {
        e.preventDefault();
        var form = jQuery(e.currentTarget).parent('form');
        let tags = [];
    ...
    jQuery(document).on('click', '.product-block .btn-tags', e => {
        e.preventDefault();
        var tags = [];
        var tag = jQuery(e.currentTarget).text();
        tags.push(tag);
